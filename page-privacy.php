...
<section class="ly_section hp_ptMd hp_pbLg">
    <div class="ly_inner">
        <h2 class="el_page_ttl hp_mbMd">PRIVACY</h2>
        <p class="el_privacy_lead">
            合同会社Sail（以下、当サイト）は、以下のとおり個人情報保護方針を定め、個人情報保護の仕組みを構築し、全スタッフに個人情報保護の重要性の認識と取組みを徹底させることにより、個人情報の保護を推進致します。
        </p>
        ...
        <div class="bl_privacy_article hp_mt50 hp_mb50">
            ...
            <p>合同会社Sail</p>
            <p>福岡県福岡市博多区博多駅東１-13-17 松岡ビル7F</p>
            <p>092-710-5907</p>
        </div>
    </div>
</section>
