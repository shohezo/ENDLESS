...
<section class="ly_section hp_ptMd hp_pbLg" id="concept-p">
    <div class="ly_inner">
        <h2 class="el_page_ttl hp_mbMd">CONCEPT</h2>
        <h2 class="el_section_lead hp_mbMd">あなたのキレイをずっと支える。</h2>
        <div class="bl_section hp_flex hp_ptSm hp_pbSM">
            <div class="bl_section_body">
                ...
                <p class="bl_section_txt">
                    お客様からよく頂戴するお言葉のひとつです。<br />
                    これまで、中々結果が出ない。<br />
                    脱毛が痛くて途中でやめてしまった。<br />
                    費用がすごく負担で続けられなかった。<br />
                    そんなお客様にそっと、ずっと寄り添うサロンを作りたい。<br />
                    そうしてENDLESSは生まれました。<br />
                </p>
            </div>
            <figure class="bl_section_imgWrapper">
                <img src="<?php bloginfo('template_url');?>/img/concept01.jpeg" alt="顎に手を添える女性" />
            </figure>
        </div>
        <div class="bl_section hp_flex hp_reverse hp_pbSm hp_ptSm">
            <div class="bl_section_body">
                ...
                <p class="bl_section_txt">
                    通わなくちゃ…<br />
                    ではなく、「待ち遠しいな」になるような空間づくり。<br />
                    一番お客様に近い施術スタッフ自身が考え抜いたサービスだから
                    自身を持ってお迎えすることができます。<br />
                </p>
            </div>
            <figure class="bl_section_imgWrapper">
                <img src="<?php bloginfo('template_url');?>/img/concept02.jpeg" alt="タオルを巻いた女性" />
            </figure>
        </div>
        <div class="bl_section hp_flex hp_ptSm hp_pbSM">
            <div class="bl_section_body">
                ...
                <p class="bl_section_txt">
                    脱毛やホワイトニングで外見は綺麗になります。<br />
                    同時に私たちが目指すのはお客様のトータルビューティ。<br />
                    じっくりとお客様のお悩みを聴かせていただき<br />
                    内面からも美しさが滲み出るようなサポートができれば
                    これ以上の喜びはありません。<br />
                </p>
            </div>
            <figure class="bl_section_imgWrapper">
                <img src="<?php bloginfo('template_url');?>/img/concept03.jpeg" alt="カメラ目線の女性" />
            </figure>
        </div>
    </div>
</section>
