...
<section class="ly_section hp_ptMd hp_pbLg" id="menu-p">
    <div class="ly_inner">
        <h2 class="el_page_ttl hp_mbMd">MENU</h2>
        <h2 class="el_section_lead hp_mbMd">明瞭で安心な料金体系。</h2>
        <h2 class="el_section_lead">メニュー</h2>
        <span class="el_section_subLead hp_mbSm">MENU</span>
            ...
            <div class="bl_cardUnit bl_cardUnit__col2 hp_jcc">
                <div class="bl_card hp_mbMd">
                    <div class="bl_card_body">
                        ...
                        <p class="bl_card_price">
                            <span>月額 </span>8,900 <span>円〜</span>
                        </p>
                        <p>回数／無制限
                        </p>
                    </div>
                ...
                <div class="bl_card hp_mbMd">
                    <div class="bl_card_body">
                        ...
                        <p class="bl_card_price">
                            <span>月額 </span>6,900 <span>円〜</span>
                        </p>
                        <p>回数／5回
                        </p>
                    </div>
                ...
                <div class="bl_card">
                    <div class="bl_card_body">
                        ...
                        <p class="bl_card_price">
                            <span>月額 </span>3,400 <span>円〜</span>
                        </p>
                        <p>回数／5回
                        </p>
                    </div>
                ...
                <div class="bl_card">
                    <div class="bl_card_body">
                        ...
                        <p class="bl_card_price">
                            <span>月額 </span>16,000 <span>円〜</span>
                        </p>
                        <p>回数／無制限
                        </p>
                    </div>
